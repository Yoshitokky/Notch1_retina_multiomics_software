...
DotPlot(RNA_d78_065_anno, features = anno_markers) + 
  ...
  RotatedAxis() +
  scale_y_discrete(
    limits = c("RPC1", "RPC2", "RPC3", "Proliferating RPC1", "Proliferating RPC2", 
               "ONECUT1+/2+ RPC2", "ONECUT1+/2+ RPC1",
               "ONECUT1+/MEIS2+ RPC1", "ONECUT1+/MEIS2+ RPC2",
               "ONECUT1+/MEIS2+ RPC3", "VSX2++ RPC",
               "ONECUT1+/2+/PTF1A+ RPC", "ONECUT1+/2+/LHX1+ RPC",
               "ELAVL2+/4+ RPC1", "ELAVL2+/4+ RPC2","ELAVL2+/4+ RPC3",
               "EEF1A1+ RPC")
  )
