...
DotPlot(RNA_d74_07_anno, features = anno_markers) + 
  ...
  RotatedAxis() +
  scale_y_discrete(
    limits = c("RPC1", "RPC2", "RPC3",  "RPC4", "RPC5", "RPC6",
               "ELAVL2+/4+ RPC1", "ELAVL2+/4+ RPC2",
               "ELAVL2+/4+ RPC3", "ONECUT2+ RPC", "ONECUT1+/2+/LHX1+/PTF1A+ RPC1",
               "ONECUT1+/2+/LHX1+/PTF1A+ RPC2", "ONECUT1+/MEIS2+ RPC1",
               "ONECUT1+/MEIS2+ RPC2", "VSX2++ RPC")
  )
